...
public class DirectionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // check if there is a savedInstanceState && our boolean array exists
    ...
    private void setUpCheckBoxes(String[] directions, ViewGroup container, boolean[] checkedBoxes) {
        ...
        for (String direction : directions) {
            ...
            // if checkbox should be checked according to savedInstanceState
            if (checkedBoxes[i]) {
    ...
    public void onSaveInstanceState(Bundle outState) {
        // this code saved checked state of checkboxes when orientation is changed
